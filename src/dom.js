...
export const filterMyModules = document.getElementById('filterMyModules');
export const mobileFilterMyModules = document.getElementById('mobileFilterMyModules');
...
export const btnDeleteMark = document.getElementById('btn-delete-mark');
